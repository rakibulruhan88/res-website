...
<section className="bg-gray-100 rounded-lg">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 rounded-sm">
    <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5 ">
      {/* <div className="lg:col-span-2 lg:py-12">
        ...
        <div className="mt-8">
          <a href="tel" className="text-2xl font-bold text-pink-600"> 01754130469 </a>
      ...
      <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
        <form action="#" className="space-y-4">
          ...
          <div className="mt-4">
            <button
              type="submit"
              className="inline-block w-full rounded-lg bg-orange-400 hover:bg-red-500 hover:s px-5 py-3 font-medium text-white sm:w-auto"
            >
              Send Enquiry
            </button>
          </div>
